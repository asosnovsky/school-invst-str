...
\section{Model Application} 
	...
	\\
	This identification provided us with the following schools (please note that this is not the entire dataset, the full dataset will be provided separately). As can be seen in fig.\ref{fig:kNN}.
	\begin{figure}[H]
		\centering
